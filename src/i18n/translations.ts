...
export const i18n = {
  ...
  industries: {
    ...
    items: [
      {
        emoji: "🏠",
        title: { es: "Bienes Raíces", en: "Real Estate" },
        description: { es: "Agenda visitas, califica compradores y hace seguimiento de propiedades de forma automática.", en: "Schedule visits, qualify buyers, and follow up on properties automatically." },
        stats: { es: "+40% leads calificados", en: "+40% qualified leads" },
      },
      {
        emoji: "🛍️",
        title: { es: "E-commerce & Retail", en: "E-commerce & Retail" },
        description: { es: "Recupera carritos abandonados, resuelve dudas y gestiona devoluciones 24/7.", en: "Recover abandoned carts, resolve queries, and manage returns 24/7." },
        stats: { es: "+25% recuperación de ventas", en: "+25% sales recovery" },
      },
      {
        emoji: "🏥",
        title: { es: "Salud & Bienestar", en: "Health & Wellness" },
        description: { es: "Agenda citas, envía recordatorios y da seguimiento a pacientes sin carga administrativa.", en: "Schedule appointments, send reminders, and follow up with patients without admin burden." },
        stats: { es: "-60% no-shows", en: "-60% no-shows" },
      },
      {
        emoji: "🍽️",
        title: { es: "Restaurantes & Hospitality", en: "Restaurants & Hospitality" },
        description: { es: "Reservas automáticas, atención a consultas y programas de fidelidad gestionados por IA.", en: "Automatic reservations, query handling, and loyalty programs managed by AI." },
        stats: { es: "+35% reservas directas", en: "+35% direct bookings" },
      },
      {
        emoji: "🎓",
        title: { es: "Educación", en: "Education" },
        description: { es: "Inscripciones, consultas de cursos y soporte a estudiantes atendidos automáticamente.", en: "Enrollments, course inquiries, and student support handled automatically." },
        stats: { es: "+50% tasa de inscripción", en: "+50% enrollment rate" },
      },
      {
        emoji: "💼",
        title: { es: "Servicios Profesionales", en: "Professional Services" },
        description: { es: "Califica prospectos, agenda reuniones y nutre leads para consultoras, agencias y despachos.", en: "Qualify prospects, schedule meetings, and nurture leads for consultancies and agencies." },
        stats: { es: "3x más reuniones agendadas", en: "3x more meetings booked" },
      },
    ],
  },
  ...
  contact: {
    ...
    headline: { es: "¿Listo para automatizar tu negocio?", en: "Ready to automate your business?" },
    subhead: {
      es: "Agenda una demo gratuita de 30 minutos. Te mostramos los 3 agentes en acción con datos de tu industria.",
      en: "Schedule a free 30-minute demo. We'll show you all 3 agents in action with data from your industry.",
    },
    location: { es: "Ubicación", en: "Location" },
    locationValue: { es: "Ketchum, Idaho · Corrientes, Argentina", en: "Ketchum, Idaho · Corrientes, Argentina" },
    email: { es: "Email", en: "Email" },
    availability: { es: "Disponibilidad", en: "Availability" },
    availabilityValue: { es: "Lun - Vie, 9am - 6pm MST", en: "Mon - Fri, 9am - 6pm MST" },
    ...
    messagePlaceholder: {
      es: "Cuéntanos sobre tu negocio y qué te gustaría automatizar...",
      en: "Tell us about your business and what you'd like to automate...",
    },
    nameLabel: { es: "Nombre", en: "Name" },
    emailLabel: { es: "Email", en: "Email" },
    companyLabel: { es: "Empresa", en: "Company" },
    messageLabel: { es: "¿En qué podemos ayudarte?", en: "How can we help?" },
    submit: { es: "Enviar solicitud", en: "Send Request" },
    orBook: { es: "O agenda directamente", en: "Or book directly" },
    onCalendar: { es: "en nuestro calendario", en: "on our calendar" },
  },
